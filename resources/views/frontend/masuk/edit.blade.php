...
<div class="container">
    <div class="row">
        <h3 class="text-center py-3">Barang Masuk | Edit Data</h3>
    </div>
    <!-- Content -->
    <div class="card border-1 shadow-sm rounded">
        <div class="card-body">
            ...
            <div class="row">
                <form action="{{ route('masuk.update', $rsMasuk->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <a href="{{ route('masuk.index') }}" class="btn btn-md btn-dark mb-3">CANCEL</a>
                        </div>
                    </div>
                </form>
            </div>
