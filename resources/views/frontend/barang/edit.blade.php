...
<div class="container">
    <div class="row">
        <h3 class="text-center py-3">Barang | Edit Data</h3>
    </div>
    <!-- Content -->
            ...
            <form action="{{ route('barang.update', $rsBarang->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="seri" 
                            ...
                            id="seri" placeholder="Seri"
                            value="{{old('seri',$rsBarang->seri)}}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="spesifikasi" 
                            ...
                            id="spesifikasi" placeholder="Spesifikasi"
                            value="{{old('spesifikasi',$rsBarang->spesifikasi)}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <a href="{{ route('barang.index') }}" class="btn btn-md btn-dark mb-3">CANCEL</a>
                        </div>
                    </div>
                </form>
            </div>
