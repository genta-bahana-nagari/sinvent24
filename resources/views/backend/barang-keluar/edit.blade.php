...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col">
                <h3 class="text-center my-4" style="color: black;">Laravel CRUD Barang Keluar | Edit</h3>
                        ...
                        <form action="{{ route('barang-keluar.update', $rsKeluar->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col text-end">
                                    <a href="{{ route('barang-keluar.index') }}" class="btn btn-md btn-dark mb-3">CANCEL</a>
                                </div>
                            </div>
                        </form>
                    </div>
