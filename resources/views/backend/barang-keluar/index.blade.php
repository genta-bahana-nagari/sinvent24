    ...
    @section('content')
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div>
                    <h3 class="text-center my-4" style="color: black; font-weight: 750;">Barang Keluar | Kelompok 1</h3>
                    </div>
                    <!-- membuat card  -->
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <a href="{{ route('barang-keluar.create') }}" class="btn btn-md btn-success mb-3"
                                    style="opacity: 0.75;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('barang-keluar.destroy', $rowKeluar->id) }}" method="POST">
                                                <a href="{{ route('barang-keluar.show', $rowKeluar->id) }}" class="btn btn-sm btn-dark" style="opacity: 0.75;">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a href="{{ route('barang-keluar.edit', $rowKeluar->id) }}" class="btn btn-sm btn-primary"  style="opacity: 0.75;">
