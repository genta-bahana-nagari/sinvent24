    ...
    @section('content')
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div>
                    <h3 class="text-center my-4" style="color: black; font-weight: 750;">Barang Masuk | Kelompok 1</h3>
                    </div>
                    <!-- membuat card  -->
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <a href="{{ route('barang-masuk.create') }}" class="btn btn-md btn-success mb-3"
                                    style="opacity: 0.75;">
